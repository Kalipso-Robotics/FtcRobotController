...
@Autonomous(name = "RedAutoNearZone2")
public class RedAutoNear2 extends KTeleOp {
    ...
    final double THIRD_BALL_X = 680;
    final double THIRD_BALL_Y = 1050 * allianceSetup.getPolarity();
    final double SECOND_BALL_X = 1230;
    final double SECOND_BALL_Y = 1000 * allianceSetup.getPolarity();
    final double FIRST_BALL_X = 1830;
    final double FIRST_BALL_Y = 1000 * allianceSetup.getPolarity();
...
//        fullShootMotifAction = new FullShootMotifAction(revolver, shooter, testingMotif, colorSensors, opModeUtilities);
    ...
    public void runOpMode() throws InterruptedException {
        ...
        ShooterReady ready = new ShooterReady(shooter, Shooter.RED_TARGET_FROM_FAR.multiplyY(allianceSetup.getPolarity()), LaunchPosition.MIDDLE_RED); //TODO launch pos with polarity
        ready.setName("ready");
        ...
        moveToFirstBalls.addPoint(THIRD_BALL_X, FIRST_BALL_Y - 660, 90 * allianceSetup.getPolarity());
        moveToFirstBalls.addPoint(THIRD_BALL_X, FIRST_BALL_Y, 90 * allianceSetup.getPolarity());
...
//
//        ShooterReady ready2 = new ShooterReady(shooter, Shooter.RED_TARGET_FROM_FAR, LaunchPosition.MIDDLE_RED);
...
//
//        ShooterReady ready3 = new ShooterReady(shooter, Shooter.RED_TARGET_FROM_FAR, LaunchPosition.MIDDLE_RED);
