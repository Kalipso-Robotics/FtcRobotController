...
public class TurretConfig { //
    ...
    public static double kP = 0.0025;   // faster response 0.004
    public static double kI = 0;       // keep at 0
    public static double kD = 0.0001;  // reduces overshoot (main time saver) 0.0003
    public static double kS = 0.1;    // faster final approach
