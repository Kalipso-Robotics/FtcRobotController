...
public class RunIntakeUntilFullSpeed extends Action {
    ...
    private static final double FULL_SPEED_THRESHOLD = TARGET_VELOCITY * 0.8; // ~2642 ticks/sec / observed full speed velocity ~2000 ticks / sec, low velocity 500-900
    private double fullSpeedDurationMS = 150;

    private final ElapsedTime fullSpeedTimer;
