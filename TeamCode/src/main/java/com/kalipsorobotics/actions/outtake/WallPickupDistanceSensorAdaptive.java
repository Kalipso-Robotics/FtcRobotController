...
public class WallPickupDistanceSensorAdaptive extends Action {

    Rev2mDistanceSensor revDistance;
    DistanceDetectionAction detectDistanceAction;
    AdaptivePurePursuitAction purePursuitAction;
    KServoAutoAction outtakeClawClose;
    MoveToDistanceThreshold moveToDistanceThreshold;
    WaitAction timeout;

    public WallPickupDistanceSensorAdaptive(Outtake outtake, AdaptivePurePursuitAction purePursuitAction, DriveTrain driveTrain) {
