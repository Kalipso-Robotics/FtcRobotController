...
public class ShooterInterpolationConfig {
    ...
    public static double[] shooterData = {
        ...
        710, 32 - 0.7, MIN_HOOD,
        890, 32.7 - 1, MIN_HOOD,
        1115, 34.2 - 2.4, MIN_HOOD, // Near Auto First shoot, tuned, near auto distance: 1037.1287983659502
        ...
        2570, 45.2 + 0.4, MAX_HOOD,
        2760, 47 - 0.1, MAX_HOOD, // TIP AREA DON'T TOUCH, far shoot
        2965, 48.2 - 1.4, MAX_HOOD, // TIP AREA !!! very good like 80% accuracy DON'T TOUCH. far shoot
        3095, 48.3 - 1, MAX_HOOD, // FAR SHOOT, first shoot ( 0 , 0 )
        3300, 48.8 - 0.9, MAX_HOOD,
        3500, 49.3 - 0.9, MAX_HOOD,
    };
