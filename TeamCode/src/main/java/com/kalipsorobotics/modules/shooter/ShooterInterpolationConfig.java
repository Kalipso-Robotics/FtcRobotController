...
public class ShooterInterpolationConfig {
    ...
    public static double[] shooterData = {
            ...
            918, 33.4 + 0.5, 0.1,
            1126, 32 + 0.5, 0.2,
            1143.96, 31.5 + 0.5, MAX_HOOD, // FIRST SHOOT NEAR,
            1251.09, 32.14 + 0.5, MAX_HOOD,
            1290.48, 31.43 + 0.5, MAX_HOOD,
            1321.83, 30.71 + 0.5, MAX_HOOD,
            1341.74, 32.14 + 0.5, MAX_HOOD,
            1411.42, 32.86 + 0.5, MAX_HOOD,
            1496.56, 30 + 0.5, MAX_HOOD,
            1496.59, 32.86 + 0.5, MAX_HOOD,
            1526.71, 34.29 + 0.5, MAX_HOOD,
            1595.31 + 0.5, NEAR_SHOOT_RPS, MAX_HOOD, // SECOND SHOOT NEAR,
            1700.15, 32.14 + 0.5, MAX_HOOD,
            1813.77, 32.86 + 0.5, MAX_HOOD,
            ...
            2865.43, 43.29 + 1, MAX_HOOD,
            3001.9, 45 + 1, MAX_HOOD,
