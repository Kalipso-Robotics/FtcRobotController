...
public class Revolver {
    ...
    public static final double REVOLVER_INDEX_0 = 0.11; //+ for counterclockwise
    public static final double  REVOLVER_INDEX_1 = 0.51;
    public static final double REVOLVER_INDEX_2 = 0.91;
