...
import com.kalipsorobotics.actions.outtake.WallPickupDistanceSensorAdaptive;
...
@Autonomous(name = "AutoSpecimen  2 SPECIMEN + 2 PUSH + ADAPTIVE")
public class AutoSpecimenAdaptive extends LinearOpMode {
...
//        initAuto.update();
        ...
        AdaptivePurePursuitAction moveFloorSamples = new AdaptivePurePursuitAction(driveTrain, wheelOdometry);
        ...
        //move to sample:
        moveFloorSamples.addPoint(-570, 130, -90); //
        //turning:
        moveFloorSamples.addPoint(-900, -500, -175); // y
        //move back:
        ...
        moveFloorSamples.addPoint(-1330, -775, -180);//before push y=800
        moveFloorSamples.addPoint(-610, -825, -180);
        moveFloorSamples.addPoint(-380, -675, -180);

        final double WALL_PICKUP_Y = -1108;
        //second sample to depot
        moveFloorSamples.addPoint(-1000, -675, -180); //y
        moveFloorSamples.addPoint(-1400, -675, -180); //y
        moveFloorSamples.addPoint(-1400, WALL_PICKUP_Y, -180);//
        moveFloorSamples.addPoint(-300,WALL_PICKUP_Y,-180);
        ...
        WallPickupDistanceSensorAdaptive wallPickupDistanceSensorAction = new WallPickupDistanceSensorAdaptive(outtake, moveFloorSamples, driveTrain);
